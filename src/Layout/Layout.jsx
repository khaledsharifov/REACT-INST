        ...
        <div className="navbar  ">
          ...
          <div className='w-[16%] px-4 border-r h-[100vh] fixed left-0 '>
            ...
            <ul className=''>
              ...
              <li className='flex items-center gap-4 py-[10px] rounded-[12px] px-3 cursor-pointer hover:bg-[#eee] my-[6px] text-[15px]'><SearchIcon sx={{fontSize: "30px"}}/>Search</li>
            ...
            <div className='flex items-center gap-4 py-[12px] mt-12 rounded-[12px] px-3 cursor-pointer hover:bg-[#eee] my-[6px] text-[15px]'><MenuRoundedIcon sx={{fontSize: "30px"}}/> More</div>
          </div>
        <Outlet/>
        </div>
    </div>
